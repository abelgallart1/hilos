 ...
 * @author abel
 */
public class Carnivoro extends Ser{
    public Carnivoro(String especie,String audio,Icon imagenCria,Icon imagenAdulto,boolean hembra,JPanel panel,ArrayList colonia,
...
public Object clone(){
    ...
    Carnivoro hor= new Carnivoro(especie,audio,imagenCria,imagenAdulto,hembra,panel,colonia,
               esperanzadevida,limiteedadreproduccion,edadadulta,limitedescendientes,traslacion,hambre);
   ...
   if (! especie(otro)) return;
    ...
    if (
        ...
        (esAdulto()&&!esHembra()&&otro.esAdulto()&&otro.esHembra()))
         ...
         Carnivoro indi=new Carnivoro(especie,audio,imagenCria,imagenAdulto,hembra,panel,colonia,
               esperanzadevida,limiteedadreproduccion,edadadulta,limitedescendientes,traslacion,hambre);
